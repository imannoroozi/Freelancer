...
public final class Farsi {
	...
	public static final String ConvertForPrinterWoosim(String In) {
		try {
			...
			Out = Out.replace(szLamAndAlefWoosim, szLaWoosim); // Join 'Lam' and
																// 'Alef' and
			// make 'La'
			Out = Out.replace(szLamStickAndAlefWoosim, szLaStickWoosim); // Join
																			// 'Lam
																			// Stick'
			// and 'Alef'
			// and make 'La
