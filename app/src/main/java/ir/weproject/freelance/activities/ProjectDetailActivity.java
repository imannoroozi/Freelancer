...
public class ProjectDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.project_detail_employer);
...
//        drawerItem[2] = new ObjectDrawerItem(R.drawable.ic_do_not_disturb_alt_black_24dp, "Help");
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
                case 0: //Profile
                    intent = new Intent(ProjectDetailActivity.this,ProfileActivity.class);
                    startActivity(intent);
                    break;
                case 1: //Post
                    intent = new Intent(ProjectDetailActivity.this,PostProjectActivity.class);
                    startActivity(intent);
                    break;
                case 2: //Followings
                    intent = new Intent(ProjectDetailActivity.this,FollowingListActivity.class);
                    startActivity(intent);
                    break;
                case 3: //Search
                    break;
                case 4: // Log out
                    ...
                    intent = new Intent(ProjectDetailActivity.this,LoginActivity.class);
                    startActivity(intent);
                    break;
                case 5: //About
                    break;
