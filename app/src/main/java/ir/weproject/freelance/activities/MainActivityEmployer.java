...
public class MainActivityEmployer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //makeProject.setOnClickListener(new ButtonClickListener());
...
//        drawerItem[2] = new ObjectDrawerItem(R.drawable.ic_do_not_disturb_alt_black_24dp, "Help");
        ...
        makeProject = (Button) findViewById(R.id.makeButton);
        makeProject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(MainActivityEmployer.this, ProjectTypeEmployerActivity.class);
    ...
    private class ButtonClickListener implements Button.OnClickListener {
        ...
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(MainActivityEmployer.this,ProjectTypeEmployerActivity.class);
    ...
    */
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
                case 0: //Profile
                    intent = new Intent(MainActivityEmployer.this,ProfileActivity.class);
                    startActivity(intent);
                    break;
                case 1: //Post
                    intent = new Intent(MainActivityEmployer.this,PostProjectActivity.class);
                    startActivity(intent);
                    break;
                case 2: //Followings
                    intent = new Intent(MainActivityEmployer.this,FollowingListActivity.class);
                    startActivity(intent);
                    break;
                case 3: //Search
                    break;
                case 4: // Log out
                    ...
                    intent = new Intent(MainActivityEmployer.this,LoginActivity.class);
                    startActivity(intent);
                    break;
                case 5: //About
                    break;
